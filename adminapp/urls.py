...
from adminapp.views import UserListView, UserCreateView, UserUpdateView, UserDeleteView, ProductsListView
...
urlpatterns = [
    ...
    path('products/read/', ProductsListView.as_view(), name='products_list'),
